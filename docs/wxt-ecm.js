...
var oneDriveFilePickerError =
    function ( e ) {
        ...
        // Android
        if (typeof ECMExtensions !== "undefined" && ECMExtensions.ecmError) {
            ECMExtensions.ecmError(JSON.stringify(e, null, 4));
        }
    }
var oneDriveFilePickerSuccess =
    function ( filesinfo ) {
        ...
        // Android
        if (typeof ECMExtensions !== "undefined" && ECMExtensions.ecmShare) {
            var msg = { files : getInfo(filesinfo)};
            ECMExtensions.ecmShare(JSON.stringify(msg,null,2));
        }
    }
var oneDriveFilePickerCancel =
    function ( ) {
        ...
        // Android
        if (typeof ECMExtensions !== "undefined" && ECMExtensions.ecmCancel) {
